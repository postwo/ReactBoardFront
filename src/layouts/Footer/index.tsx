...
export default function Footer() {
    ...
    const onNaverBlogIconButtonClickHandler = () =>{ //페이지 이동
        ...
        <div className='footer-container'>
            <div className='footer-top'>
                ...
                <div className='footer-link-box'>
                    <div className='footer-email-link'>{'codo7717@naver.com'}</div>
            ...
            <div className='gooter-bottom'>
                <div className='footer-copyright'>{'Copyright @ 2024 chieon. All Rights Reserved.'}</div>
            </div>
        </div>
    </div>
  )
